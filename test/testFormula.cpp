...
TEST(DiscreteFormula, DiscreteAtomicProperty) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("DiscreteAtomicFormula.xml");
...
TEST(ContinuousFormula, ContinuousAtomicProperty){
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("ContinuousAtomicFormula.xml");
...
TEST(ConjunctionFormula, DiscreteAtomicProperty) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("ConjunctionFormula.xml");
...
TEST(NegationFormula, ContinuousAtomicProperty) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("NegationFormula.xml");
...
TEST(Interleaved, NegationOfConjunction) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("InterleavedFormula.xml");
    EXPECT_EQ(Formula::Type::Negation, formula->getType());
...
TEST(Until, DiscreteUntilDiscrete) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("UntilFormula.xml");
...
TEST(Until, UntilWithNegation) {
    std::shared_ptr<Formula> formula = ReadFormula{}.readFormula("UntilWithNegationFormula.xml");
    EXPECT_EQ(Formula::Type::Until, formula->getType());
