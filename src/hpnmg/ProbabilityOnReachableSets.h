...
namespace hpnmg {
	...
	public:
		...
		std::vector<std::pair<double,double>> calculateProbabilityOnReachableSet(shared_ptr<HybridPetrinet>  hybridPetriNet, std::vector<std::function<bool(int, Point<Number>)>> properties,std::vector<string> printProperties, double tMax);
